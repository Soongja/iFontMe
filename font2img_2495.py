...
unicode_list = open('unicode_2495.txt')
...
parser.add_argument('--sample_count', dest='sample_count', type=int, default=2495, help='number of characters to draw')
...
if __name__ == "__main__":
    charset = unicode_list.read().split('\n')
    if args.shuffle:
